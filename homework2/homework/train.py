    ...
    **kwargs,
    ...
    for epoch in range(num_epoch):
        ...
        for img, label in train_data:
            ...
            # Log loss and append accuracy directly to existing structures
        ...
        with torch.inference_mode():
            ...
            for img, label in val_data:
                ...
                # Compute validation accuracy inline
                metrics["val_acc"].append((model(img).argmax(dim=1) == label).float().mean().item())
